...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    func insertNewEntry() {
        ...
        let newEntry = NSEntityDescription.insertNewObjectForEntityForName(entity.name!, inManagedObjectContext: context) as! Entry
        ...
        performSegueWithIdentifier("showDetail", sender: newEntry)
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "showDetail" {
            ...
            if let indexPath = self.tableView.indexPathForSelectedRow {
                controller.entry = self.fetchedResultsController.objectAtIndexPath(indexPath) as? Entry
            }
            else {
